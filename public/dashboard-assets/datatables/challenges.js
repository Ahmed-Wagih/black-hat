...
var KTDocsList = (function () {
    ...
    var toolbarSelected;
    var selectedCount;
    var lang = ""; // Initialize lang variable
    ...
    // Function to update lang variable
    function updateLang() {
        lang = getLangFromURL();
    }
        ...
        datatable = $(table).DataTable({
            ...
            columns: [
...

                {
                    ...
                    render: function (data, type, row) {
                        if (lang === "ar") {
                            return row.challengecategory.name_ar;
                        } else {
                            return row.challengecategory.name_en;
                        }
                    },
                },
                { data: "pointes" },
            ...
            columnDefs: [
                ...
                {
                    targets: 3, // Index of the "cover_image" column
                    render: function (data) {
                        return `<img src="/storage/challenges/${data}" width="100" height="100" />`; // Adjust the width and height as needed
                    },
                },
                {
                    targets: -1,
