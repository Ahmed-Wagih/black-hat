...
class interestRepository extends BasicRepository implements IAdminRepository, IMainRepository
{
    /**
     * @var array
     */
    ...
    {
        if (isset($data['icon'])) {
            $data['icon']  = storeImage('Interests', $data['icon']);
        }
    ...
    public function update($request, $id = null)
    {
        ...
        if (isset($request['icon'])) {
            $request['icon'] =  storeImage('Interests', $request['icon']);
            deleteImage('Interests', $interest['icon']);
        }
