...
@push('styles')
    <style>
        ...
        .agenda-page .events .cardS1 .head .head-image{
            width: 100%;
        }
    </style>
@endpush
        ...
        <div class="main">
            <div class="content">
                ...
                <div class="search">
                    ...
                    <div class="tags">
                        <a href="{{ route('web.agenda.all_agendas') }}">
                            <div class="tag" style="background: #080">
                                <span>{{ __('All') }}</span>
                            </div>
                        </a>
                        @foreach ($categories as $category)
                            <a href="{{ route('web.agenda.all_agendas', ['category_id' => $category->id]) }}">
