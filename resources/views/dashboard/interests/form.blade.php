...
<div class="row mb-8">
    <div class="fv-row mb-7">
        ...
        style="background-image: url('{{ isset($interest) && $interest->icon ? getImage('Interests',$interest->icon)  : 'assets/media/svg/avatars/blank.svg' }}')">
       ...
       <div class="col-md-6 fv-row">
        ...
        <div class="form-floating">
            <input type="text" class="form-control @error('name_ar') is-invalid @enderror" id="name_ar_inp"
                name="name_ar"  value="{{ old('name_ar', isset($interest) ? $interest : '') }}"
                autocomplete="off" />
    ...
    <div class="col-md-6 fv-row">
        ...
        <div class="form-floating">
            <input type="text" class="form-control @error('name_en') is-invalid @enderror" id="name_en_inp"
                name="name_en"  value="{{ old('name_en', isset($interest) ? $interest : '') }}"
                autocomplete="off" />
...
@push('scripts')
    ...
    {!! JsValidator::formRequest('App\Http\Requests\InterestRequest') !!}
@endpush
