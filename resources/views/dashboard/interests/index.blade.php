...
@section('page_title', 'interests List')
@section('content')
<!--begin::Toolbar-->
<div class="toolbar d-flex flex-stack mb-3 mb-lg-5" id="kt_toolbar">
    ...
    @component('dashboard.components.breadcrumb')
        ...
        <!--begin::Item-->
            <li class="breadcrumb-item text-muted">{{__('admin.interests')}}</li><!--end::Item-->
    ...
    <div id="kt_content_container" class="container-xxl">
        ...
        <div class="d-flex flex-stack mb-5">
            ...
            <div class="d-flex align-items-center position-relative my-1">
                ...
                <input type="text" data-kt-docs-table-filter="search" class="form-control form-control-solid w-250px ps-14" placeholder="{{__('admin.search')}} {{ __('admin.interest') }}" />
            </div><!--end::Search-->
            ...
            <div class="d-flex justify-content-end" data-kt-docs-table-toolbar="base">
                ...
                <!--begin::Add customer-->
                <a href="{{route('interests.create')}}" type="button" class="btn btn-primary" data-bs-toggle="tooltip">
                    {{__('admin.add')}} {{ __('admin.interest') }}
                </a><!--end::Add customer-->
            </div><!--end::Toolbar-->
...
{{--    ?v={{ now() }}--}}
    <script>
        var route = "{{ route('interests.index', Request()->all()) }}";
        var csrfToken = "{{ csrf_token() }}";
    </script>
    <script src="{{ asset('dashboard-assets/datatables/interests.js') }}"></script>
@endpush
