            ...
            <div class="d-flex flex-stack mb-5">
                ...
                <div class="d-flex align-items-center position-relative my-1">
                    ...
                    <input type="text" data-kt-docs-table-filter="search"
                        class="form-control form-control-solid w-250px ps-14" placeholder="{{ __('admin.search') }} {{ __("admin.Admin") }}" />
                </div><!--end::Search-->
                ...
                <div class="d-flex justify-content-end" data-kt-docs-table-toolbar="base">
                    ...
                    <div class="menu menu-sub menu-sub-dropdown w-300px w-md-325px" data-kt-menu="true">
                        <!--begin::Header-->
                        <div class="px-7 py-5">
                            <div class="fs-5 text-dark fw-bold">{{ __('admin.search') }}</div>
                        </div><!--end::Header-->
                        ...
                        <div class="px-7 py-5" data-kt-docs-table-filter="form">
                            <!--begin::Input group-->
                            <div class="mb-10">
                                <label class="form-label fs-6 fw-semibold">{{ __('admin.search') }}</label>
            ...
            <table id="kt_datatable_example_1" class="table align-middle table-row-dashed fs-6 gy-5">
                <thead>
                    <tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase gs-0">
                        ...
                        <th class="text-center min-w-100px">{{ __('admin.Actions') }}</th>
                    </tr>
                </thead>
