...
@section('page_title', 'challengecategories List')
@section('content')
<!--begin::Toolbar-->
<div class="toolbar d-flex flex-stack mb-3 mb-lg-5" id="kt_toolbar">
    ...
    @component('dashboard.components.breadcrumb')
        ...
        <!--begin::Item-->
            <li class="breadcrumb-item text-muted">{{__('admin.challengecategories')}}</li><!--end::Item-->
    ...
    <div id="kt_content_container" class="container-xxl">
        ...
        <div class="d-flex flex-stack mb-5">
            ...
            <div class="d-flex align-items-center position-relative my-1">
                ...
                <input type="text" data-kt-docs-table-filter="search" class="form-control form-control-solid w-250px ps-14" placeholder="{{__('admin.search')}} {{ __('admin.category') }}" />
            </div><!--end::Search-->
            ...
            <div class="d-flex justify-content-end" data-kt-docs-table-toolbar="base">
                    ...
                    <div class="px-7 py-5" data-kt-docs-table-filter="form">
                        ...
                        <div class="mb-10">
                            ...
                            <select class="form-select form-select-solid fw-bold" name="status" data-kt-select2="true" data-placeholder="Select option" data-allow-clear="true" data-kt-docs-table-filter="search" data-hide-search="true">
                                <option></option>
                                <option {{ old('team') == 'active' ? "selected" : '' }} value="active">{{ __('Active') }}</option>
                                <option {{ old('team') == 'pending' ? "selected" : '' }} value="pending">{{ __('Pending') }}</option>
                            </select>
                        </div><!--end::Input group-->
                ...
                <!--begin::Add customer-->
                <a href="{{route('challengecategories.create')}}" type="button" class="btn btn-primary" data-bs-toggle="tooltip">
...
{{--    ?v={{ now() }}--}}
    <script>
        var route = "{{ route('challengecategories.index', Request()->all()) }}";
        var csrfToken = "{{ csrf_token() }}";
    </script>
    <script src="{{ asset('dashboard-assets/datatables/challengecategories.js') }}"></script>
@endpush
