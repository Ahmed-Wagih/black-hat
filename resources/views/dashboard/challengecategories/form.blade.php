...
<div class="row mb-8">
    <div class="fv-row mb-7">
        ...
        style="background-image: url('{{ isset($challengecategory) && $challengecategory->icon ? getImage('Categories',$challengecategory->icon)  : 'assets/media/svg/avatars/blank.svg' }}')">
            ...
            <label class="btn btn-icon btn-circle btn-active-color-primary w-25px h-25px bg-body shadow"
                ...
                <!--begin::Inputs-->
                <input type="file" id="icon_inp"  name="icon" accept=".png, .jpg, .jpeg" />
    ...
    <div class="col-md-6 fv-row">
     ...
     <div class="form-floating">
         <input type="text" class="form-control @error('name_ar') is-invalid @enderror" id="name_ar_inp"
             name="name_ar"  value="{{ old('name_ar', isset($challengecategory) ? $challengecategory : '') }}"
             autocomplete="off" />
 ...
 <div class="col-md-6 fv-row">
     ...
     <div class="form-floating">
         <input type="text" class="form-control @error('name_en') is-invalid @enderror" id="name_en_inp"
             name="name_en"  value="{{ old('name_en', isset($challengecategory) ? $challengecategory : '') }}"
             autocomplete="off" />
...
{{-- @push('scripts')
    ...
    {!! JsValidator::formRequest('App\Http\Requests\ChallengeCategoryRequest') !!}
@endpush --}}
