...
<div class="toolbar d-flex flex-stack mb-3 mb-lg-5" id="kt_toolbar">
    ...
    @component('dashboard.components.breadcrumb')
        ...
        <!--begin::Item-->
            <li class="breadcrumb-item text-muted">{{__('admin.categories')}}</li><!--end::Item-->
    ...
    <div id="kt_content_container" class="container-xxl">
        ...
        <div class="d-flex flex-stack mb-5">
            ...
            <div class="d-flex justify-content-end" data-kt-docs-table-toolbar="base">
                ...
                <!--begin::Add customer-->
                <a href="{{route('categories.create')}}" type="button" class="btn btn-primary" data-bs-toggle="tooltip">
...
{{--    ?v={{ now() }}--}}
    <script>
        var route = "{{ route('categories.index', Request()->all()) }}";
        var csrfToken = "{{ csrf_token() }}";
    </script>
    <script src="{{ asset('dashboard-assets/datatables/categories.js') }}"></script>
@endpush
