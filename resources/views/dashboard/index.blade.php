                            ...
                            <div class="card-body d-flex justify-content-between flex-column px-0 pb-0">
                                ...
                                <div class="mb-4 px-9">
                                    ...
                                    <div class="d-flex align-items-center mb-2">
                                        <!--begin::Value-->
                                        <span
                                            class="fs-2hx fw-bold text-gray-800 me-2 lh-1">{{ __('admin.challenges') }}</span>
                                        <!--end::Value-->
                                    ...
                                    <span class="symbol-label bg-light  text-inverse fw-bold">
                                        <div class="symbol symbol-35px symbol-circle" data-bs-toggle="tooltip">
                                            <span
                                                class="symbol-label bg-gray  text-inverse fw-bold">{{ $challenges }}</span>
                                        </div>
                                    </span>
                                    <!--end::Description-->
                                </div>
                            ...
                            <div class="card-body d-flex flex-column justify-content-end pe-0">
                                ...
                                <div class="symbol-group symbol-hover flex-nowrap">
                                    @foreach ($categories as $category)
                                        @php
                                            $word = LaravelLocalization::getCurrentLocale() == 'ar' ? $category->name_ar : $category->name_en;
                                            $firstLetter = mb_strtoupper(mb_substr($word, 0, 1));
                                            
                                        @endphp
                                        <div class="symbol symbol-35px symbol-circle" data-bs-toggle="tooltip"
                                            title="{{ LaravelLocalization::getCurrentLocale() == 'ar' ? $category->name_ar : $category->name_en }}">
                            ...
                            <div class="card-body d-flex justify-content-between flex-column px-0 pb-0">
                                ...
                                <div class="mb-4 px-9">
                                    ...
                                    <div class="d-flex align-items-center mb-2">
                                        ...
                                        <!--begin::Value-->
                                        <span
                                            class="fs-2hx fw-bold text-gray-800 me-2 lh-1">{{ __('admin.challengecategories') }}</span>
                                        <!--end::Value-->
                                    ...
                                    <span class="symbol-label bg-light  text-inverse fw-bold">
                                        <div class="symbol symbol-35px symbol-circle" data-bs-toggle="tooltip">
                                            <span
                                                class="symbol-label bg-gray  text-inverse fw-bold">{{ $challengecategories }}</span>
                                        </div>
                                    </span>
                                    <!--end::Description-->
                                </div>
                            ...
                            <div class="card-header pt-5">
                                ...
                                <div class="card-title d-flex flex-column">
                                    ...
                                    <div class="d-flex align-items-center">
                                        <!--begin::Amount-->
                                        <span
                                            class="fs-2hx fw-bold text-dark me-2 lh-1 ls-n2">{{ __('admin.interests') }}</span>
                                        <!--end::Amount-->
                                    ...
                                    <div class="symbol symbol-35px symbol-circle" data-bs-toggle="tooltip">
                                        <span
                                            class="symbol-label bg-light  text-inverse fw-bold">{{ $interests }}</span>
                                    </div>
                                    <!--end::Subtitle-->
                                </div>
                                <!--end::Title-->
                            ...
                            <div class="card-body d-flex align-items-end pt-0">
                                ...
                                <div class="d-flex align-items-center flex-column mt-3 w-100">
                                    <div class="d-flex justify-content-between w-100 mt-auto mb-2">
                                        <span class="fw-bolder fs-6 text-dark">{{ __('admin.interests') }}</span>
                                        <span class="fw-bold fs-6 text-gray-400">{{ $interests }}%</span>
                                    </div>
                                    <div class="h-8px mx-3 w-100 bg-light-success rounded">
                                        <div class="bg-success rounded h-8px" role="progressbar"
                                            style="width: {{ $interests }}%;" aria-valuenow="50" aria-valuemin="0"
                            ...
                            <div class="card-body d-flex justify-content-between flex-column px-0 pb-0">
                                ...
                                <div class="mb-4 px-9">
                                    ...
                                    <div class="d-flex align-items-center mb-2">
                                        <!--begin::Value-->
                                        <span
                                            class="fs-2hx fw-bold text-gray-800 me-2 lh-1">{{ __('admin.agendas') }}</span>
                                        <!--end::Value-->

                                    </div>
                                    <!--end::Statistics-->
                                    <!--begin::Description-->
                                    <span class="fs-6 fw-semibold text-gray-400">Total {{ __('admin.agendas') }}
                                        <div class="symbol symbol-35px symbol-circle" data-bs-toggle="tooltip">
                                            <span
                                                class="symbol-label bg-light  text-inverse fw-bold">{{ $agendas }}</span>
                                        </div>
